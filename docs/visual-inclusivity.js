...
class VisualInclusivity {
    ...
    toggleContainer.innerHTML = `
      ...
      ">
        ...
        ">
          ...
          <span class="toggle-label">Enhanced Visibility</span>
        </label>
      </div>
    `;
  ...
  showModeChangeNotification() {
    ...
    const modeText = this.isVisualInclusiveMode ? 'Enhanced Visibility' : 'Standard';
  ...
  // Method to check if enhanced visibility mode is active
